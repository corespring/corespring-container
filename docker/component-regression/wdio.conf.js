exports.config = {
  ...
  //
  specs: ["components/**/dnd-categorize/**/regression/*.js"],
  // Patterns to exclude.
  exclude: [
  ...
  //
  capabilities: [{"browserName":"firefox","timeoutInSeconds":30,"defaultTimeout":30000,"waitforTimeout":30000,"name":"components-regression-test","recordVideo":false,"recordScreenshots":false}],
  //
  // ===================
  // Test Configurations
  // ===================
