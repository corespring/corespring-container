...
angular.module('corespring-common.config')
  .config(['$provide', function($provide){
    $provide.decorator('$log', function ($delegate, $sniffer) {
      return {
        info: function(m){ console.log('i am an overridden logger!!!! -- i', m);},
        debug: function(m){ console.log('i am an overridden logger!!!! -- d', m);},
        warn: function(m){ console.log('i am an overridden logger!!!! -- w', m);},
        error: function(m){ console.log('i am an overridden logger!!!! -- e', m);},
      };
    });
}]);