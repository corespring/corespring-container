...
class CoreItemTest extends Specification with Mockito {
  ...
  "saveSubset" should {
    ...
    "call hooks.saveSupportingMaterials" in new saveScope( "supporting-materials" ) {
      there was one(mockHooks).saveSupportingMaterials("id",  Json.obj(camelCase -> key))(request)
    }
