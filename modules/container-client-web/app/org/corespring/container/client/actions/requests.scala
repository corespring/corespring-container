 ...
 */
case class PlayerJsRequest[A](isSecure: Boolean, r: Request[A], errors: Seq[String] = Seq.empty, queryParams: Seq[(String, String)] = Seq.empty) extends WrappedRequest(r)
